...
#zone-menu_ {
	...
	width:652px;
	height:29px;
	background-image: url(<s:url value="/home/produits/images/zone_menu.png"/>);
}
...
#zone-aff-login_ {
	...
	width:96px;
	height:28px;
	background-image: url(<s:url value="/home/produits/images/zone_aff_login.png"/>);
}
...
#zone-principal_ {
	...
	background-image: url(<s:url value="/home/produits/images/zone_principal.jpg"/>);
}
