...
<ul id="qm0" class="qmmc">
	...
	<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="index.html">FOURNISSEURS</a>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="15%">&nbsp;</td>
    <td id="lineTitle">Fiche Produit - <font style="color:#466A9B;">DSK-201-88</font></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    ...
    <td width="50%" valign="top">
        ...
        <div id="elt">
        	<div style="margin:10px;">
        	<font style="font-size:18px; font-weight:bold;">Produit Nursie 24 Mois</font>
            <br/>
            <table width="100%" border="0">
              <tr>
                <td><div align="right">Nom produit</div></td>
                <td><input type="text" value="Efferalgan 500"\></td>
              </tr>
              <tr>
                <td><div align="right">Code produit</div></td>
                <td><input type="text" value="DSK-201-88"\></td>
              </tr>
              <tr>
                <td><div align="right">Prix</div></td>
                <td><input type="text" value="2500"\>
                  f CFA</td>
              </tr>
              <tr>
                <td><div align="right">Informations complementaires</div></td>
                <td><input type="text" style="width:350px;" value="Pas avant 12 ans"\></td>
              </tr>
              <tr>
                <td><div align="right">Stock</div></td>
                <td><input type="text" disabled='disabled' value="248"\></td>
              </tr>
              <tr>
                <td><div align="right">Vendu ce jour</div></td>
    ...
    <div class="zeze"> 
    	...
    	<tr id="header_1" height="30px">
    	    ...
    	    <td width="50%">
                <b>Statistiques</b>
                <font style="width:200px; padding-left:400px;">Elts recents&nbsp;&nbsp;&nbsp;</font>
            </td>
    	    <td>Lundi 19 Septembre 2012</td>
    	    <td width="15%">&nbsp;</td>
  	    </tr>
