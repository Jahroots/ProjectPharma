...
<div id="profile-links">Bienvenue, <a href="#" title="Edit your profile">Utilisateur</a>, <br />
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
                ...
                <li> 
					...
					<ul>
						<li><a href="../clients/listeClient" class="current">Liste des Clients</a></li>
			...
			<div class="content-box">
                ...
                <div class="content-box-content">
					...
					<div class="tab-content default-tab">
						...
						<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in porta lectus. Maecenas dignissim enim quis ipsum mattis aliquet. Maecenas id velit et elit gravida bibendum. Duis nec rutrum lorem.
						</p>
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Liste des Clients</a></li>
					</ul>
