...
<head>
<title>CorePharma</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
/*!!!!!!!!!!! QuickMenu Styles [Please Modify!] !!!!!!!!!!!*/
	...
	{	
		padding:5px;
		background-image:url(img/qmimages/center_tile.gif);
		border-width:0px;
		border-style:solid;
		border-color:#EEEEEE;
	}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr id="header_1" height="30px">
    <td width="15%">&nbsp;</td>
    <td width="50%"><b>Statistiques</b></td>
    <td>Lundi 19 Septembre 2012</td>
    <td width="15%">&nbsp;</td>
  </tr>
  <tr id="header_2">
    <td>&nbsp;</td>
    <td valign="top">
        ...
        <img src="img/logo.png" height="75"><br/>
    ...
    <td>
        ...
        <table border="0">
          <tr>
            <td><input type="text" style="color:#999; width:150px; margin:5px;" value="Recherche..."/></td>
  ...
  <tr id="header_3">
    <td background="img/qmimages/center_tile.gif" style="margin-top:10px; border-top:1px solid #FFFFFF; border-bottom:1px solid #FFFFFF;">&nbsp;</td>
    <td>
...
<ul id="qm0" class="qmmc">
	...
	<li><a class="qmparent" href="RechercheProduit.html">PRODUIT</a>
		...
		<li><a href="RechercheProduit.html">Tous les Produits</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0)">VENTE</a>
		...
		<li><span class="qmdivider qmdividerx" ></span></li>
		<li><a href="javascript:void(0);">Toutes les ventes</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0)">COMMANDES</a>
		...
		<li><a href="javascript:void(0)">Commandes en cours</a></li>
		<li><span class="qmtitle" >Par Fournisseur</span></li>
		<li><a href="javascript:void(0)">COPHARCO</a></li>
		<li><a href="javascript:void(0)">LABOREX</a></li>
		<li><a href="javascript:void(0)">CONGO PHARMA</a></li>
		<li><span class="qmdivider qmdividerx" ></span></li>
		<li><a href="javascript:void(0);">Toutes les Commandes</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0);">CLIENTS</a>
		...
		<li><a href="javascript:void(0);">Activer un Client</a></li>
		<li><span class="qmdivider qmdividerx" ></span></li>
		<li><a href="javascript:void(0);">Tous les Clients</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0);">FOURNISSEURS</a>
		...
		<li><a href="javascript:void(0);">Activer un Fournisseur</a></li>
		<li><span class="qmdivider qmdividerx" ></span></li>
		<li><a href="javascript:void(0);">Tous les Fournisseurs</a></li>
		</ul></li>
...
<script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
    ...
    <td background="img/qmimages/center_tile.gif" style="margin-top:10px; border-top:1px solid #FFFFFF; border-bottom:1px solid #FFFFFF;">&nbsp;&nbsp;&nbsp;Deconnexion</td>
    <td background="img/qmimages/center_tile.gif" style="margin-top:10px; border-top:1px solid #FFFFFF; border-bottom:1px solid #FFFFFF;">&nbsp;</td>
  </tr>
</table>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="15%">&nbsp;</td>
    <td id="lineTitle">Produits</td>
    <td width="15%" id="line">&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    ...
    <td width="50%" valign="top">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD" style="font-size:13px;">
          <tr bgcolor="#466A9B" style="color:#FFF;" align="center">
            <td width="30px" style="cursor:pointer;"><a href="RechercheProduitAvance.html">+</a></td>
            <td>Champ</td>
            <td>Operateur</td>
            <td>Valeur</td>
            <td width="30px">&nbsp;</td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD" style="font-size:13px;">
          <tr bgcolor="#466A9B" style="color:#FFF; font-size:13px;">
            <td width="20"></td>
            <td width="20" align="center"><input type="checkbox" name="selectAll" onClick="checkAll(this.checked);"></td>
            <td><div style="margin:3px;">Code produit</div></td>
            <td><div style="margin:3px;">Nom du produit</div></td>
            <td><div style="margin:3px;">Quantite <br/>en stock</div></td>
            <td><div style="margin:3px;">Vendu <br/>ce jour</div></td>
            <td><div style="margin:3px;">Prix</div></td>
            <td><div style="margin:3px;">Infos <br/>Complementaires</div></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#DDDDDD'">
            <td style="cursor:pointer;" align="center">
            <a href="produit.html">
            <img src="img/play_1.png" align="middle" onMouseOver="this.src='img/play_2.png'" onMouseOut="this.src='img/play_1.png'"/>
            </a>
            </td>
            <td align="center"><input type="checkbox" style=""></td>
            <td><div style="margin:1px;">E-90-504</div></td>
            <td><div style="margin:1px;">Efferalgan 500</div></td>
            <td><div style="margin:1px;">2700</div></td>
            <td><div style="margin:1px;">78</div></td>
            <td><div style="margin:0px 3px 0px 3px;">2500 f CFA</div></td>
            <td><div style="margin:0px 3px 0px 3px;">Pas avant 12 ans</div></td>
          </tr>
          <tr bgcolor="#EEEEEE" onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#EEEEEE'">
            <td style="cursor:pointer;" align="center">
            <a href="produit.html">
            <img src="img/play_1.png" align="middle" onMouseOver="this.src='img/play_2.png'" onMouseOut="this.src='img/play_1.png'"/>
            </a>
            ...
            <td align="center"><input type="checkbox" style=""></td>
            <td><div style="margin:1px;">E-90-504</div></td>
            <td><div style="margin:1px;">Efferalgan 250</div></td>
            <td><div style="margin:1px;">2700</div></td>
            <td><div style="margin:1px;">97</div></td>
            <td><div style="margin:0px 3px 0px 3px;">2500 f CFA</div></td>
            <td><div style="margin:0px 3px 0px 3px;">Pas avant 12 ans</div></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#DDDDDD'">
            ...
            <td align="center"><input type="checkbox" style=""></td>
            <td><div style="margin:1px;">E-90-504</div></td>
            <td><div style="margin:1px;">Efferalgan 1500</div></td>
            <td><div style="margin:1px;">2700</div></td>
            <td><div style="margin:1px;">488</div></td>
            <td><div style="margin:0px 3px 0px 3px;">2500 f CFA</div></td>
            <td><div style="margin:0px 3px 0px 3px;">Pas avant 12 ans</div></td>
          </tr>
          <tr bgcolor="#EEEEEE" onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#EEEEEE'">
            ...
            <td align="center"><input type="checkbox" style=""></td>
            <td><div style="margin:1px;">E-90-504</div></td>
            <td><div style="margin:1px;">Efferalgan 125</div></td>
            <td><div style="margin:1px;">2700</div></td>
            <td><div style="margin:1px;">45</div></td>
            <td><div style="margin:0px 3px 0px 3px;">2500 f CFA</div></td>
            <td><div style="margin:0px 3px 0px 3px;">Pas avant 12 ans</div></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#DDDDDD'">
            ...
            <td align="center"><input type="checkbox" style=""></td>
            <td><div style="margin:1px;">E-90-504</div></td>
            <td><div style="margin:1px;">Efferalgan 700</div></td>
            <td><div style="margin:1px;">2700</div></td>
            <td><div style="margin:1px;">2030</div></td>
            <td><div style="margin:0px 3px 0px 3px;">2500 f CFA</div></td>
            <td><div style="margin:0px 3px 0px 3px;">Pas avant 12 ans</div></td>
          </tr>
          <tr bgcolor="#EEEEEE" onMouseOver="this.style.backgroundColor='#ABBBD4'" onMouseOut="this.style.backgroundColor='#EEEEEE'">
    ...
    <td valign="top">
    	<div style="margin:30px 10px 10px 10px;">
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;">
              <tr style="background-image:url(img/zxzx.png); height:24px; font-size:14px;">
                <td width="30">&nbsp;</td>
                <td style="color:#FFF;">Elements Recents</td>
              </tr>
              <tr>
                <td style="border-left:solid 1px #555;">&nbsp;</td>
                <td style="border-right:solid 1px #555;">&nbsp; - Aucun enregistrement -</td>
              </tr>
              <tr>
                <td style="border-left:solid 1px #555;">&nbsp;</td>
                <td style="border-right:solid 1px #555;">&nbsp; - Aucun enregistrement -</td>
              ...
              <tr>
                <td style="border-left:solid 1px #555; border-bottom:solid 1px #555;">&nbsp;</td>
                <td style="border-right:solid 1px #555; border-bottom:solid 1px #555;">&nbsp; - Aucun enregistrement -</td>
              </tr>
            </table>
            <br/>
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;">
              <tr style="background-image:url(img/zszs.png); height:24px; font-size:14px">
                <td width="30px">&nbsp;</td>
                <td style="color:#FFF;">Alarmes</td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td style="border-left:solid 1px #09C;">&nbsp;</td>
                <td style="border-right:solid 1px #09C;">&nbsp; - Fin de stock "Melanine"                	
                </td>
              </tr>
              <tr bgcolor="#CCCCCC">
                <td style="border-left:solid 1px #09C;">&nbsp;</td>
                <td style="border-right:solid 1px #09C;">&nbsp; - Fin de stock "Malamine"</td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td style="border-left:solid 1px #09C;">&nbsp;</td>
                <td style="border-right:solid 1px #09C;">&nbsp; - Fin de stock "Betise"</td>
              </tr>
            </table>
            <br/>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;">
...
<div id="footer">
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="color:#222; font-size:12px;">
  <tr>
    <td width="15%">&nbsp;</td>
    <td style="color:#FFF;"><b>CorePharma</b></td>
    <td><div align="right" style="color:#FFF; text-decoration:underline;"><b>Vos Racccourcis</b></div></td>
    <td rowspan="6"><div style="margin:10px 0px 0px 50px; width:1px; height:50px; background-color:#000;"></div></td>
    <td><div align="right" style="color:#FFF; text-decoration:underline;"><b>Blablabla</b></div></td>
    <td rowspan="6"><div style="margin:10px 0px 0px 50px; width:1px; height:50px; background-color:#000;"></div></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="15%">&nbsp;</td>
  </tr>  
  ...
  <tr>
    <td width="15%">&nbsp;</td>
    <td>Progiciel d'aide a la gestion d'officines</td>
    <td><div align="right">Les Produits</div></td>
    <td><div align="right">Again</div></td>
    <td>&nbsp;</td>
    <td width="15%">&nbsp;</td>
  </tr>
  <tr>
    <td width="15%">&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="right">Les Vente</div></td>
    <td><div align="right">And Again ohhh</div></td>
    <td>&nbsp;</td>
    <td width="15%">&nbsp;</td>
  </tr>
  <tr>
    <td width="15%">&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="right">Les Fournisseurs</div></td>
    <td><div align="right">Every body every body say oh oh oh</div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr height="10px">
    ...
    <td></td>
    <td><div align="right"></div></td>
    <td><div align="right"></di>
    <td>&nbsp;</td><td></td>
    <tr>
    <td width="15%">&nbsp;</td>
    <td colspan="5" align="center" style="color:#000;">&copy; 2010-2011 CopyRight CorePharma | Design ... PROJECT</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
