    ...
    <td width="50%" valign="top">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD" style="font-size:13px;">
          ...
          <tr>
            ...
            <select name="champ">
            	<option>------------</option>
            	<option>Code produit</option>
            	<option>Nom du produit</option>
            	<option>Quantite en stock</option>
            	<option>Vendu ce jour</option>
            	<option>Prix</option>
            	<option>Infos complementaires</option>
            </select>
            </td>
            <td>
              <select name="champ2">
            ...
            <td style="cursor:pointer;"><center><a href="RechercheProduit.html">X</a></center></td>
          </tr>
        </table>
        
        <table width="100%" border="0">
          <tr>
            <td><input type="button" name="" value=" Filtrer "/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
        </table>
