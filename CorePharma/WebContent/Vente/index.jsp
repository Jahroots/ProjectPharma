...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr id="header_1" height="30px">
    <td width="15%">&nbsp;</td>
    <td width="50%"><b><a href = "Statistiques">Statistiques</a></b></td>
...
<ul id="qm0" class="qmmc">
	...
	<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="index.jsp">FOURNISSEURS</a>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    ...
    <td width="50%" valign="top">
        ...
        <div id="elt">
        	<div style="margin:10px;">
        	<font style="font-size:18px; font-weight:bold;">Bienvenue</font>
            <br/>
            <font style="font-size:11px;">
            Merci d'avoir choisi la SOLUTION CorePharma<br/>
            Bouuuuuuuuuuuuuuuuuns
            </font>
            </div>
        </div>
        <div id="elti"></div>
